...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/actions/boards/option/lists/option/cards/option/rename.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/actions/boards/option/lists/option/cards/option/rename.ts":
/*!***********************************************************************!*\
  !*** ./src/actions/boards/option/lists/option/cards/option/rename.ts ***!
  \***********************************************************************/
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar api_1 = __webpack_require__(/*! ../../../../../../../utils/api */ \"./src/utils/api.ts\");\nvar helper_1 = __webpack_require__(/*! ../../../../../../../utils/helper */ \"./src/utils/helper.ts\");\nif (options.lists && options.cards) {\n    var id = options.cards.id;\n    var boardName = options.boards.name;\n    var name_1 = options.lists.name;\n    var cardName = args.filter(Boolean).join(' ');\n    if (!cardName) {\n        cardName = prompt('Please enter a new card name');\n    }\n    if (id) {\n        var response = api_1.updateCard({ cardId: id, newCardName: cardName });\n        var result = response;\n        if (result.status >= 200 && result.status <= 299) {\n            result = helper_1.decodeApiResponse(response);\n            notify('Card Ranamed', 'success', 2000);\n            open(result.response.url);\n            reIndex(['trello', 'boards', boardName, 'lists', name_1, 'cards']);\n        }\n        else {\n            helper_1.handleErrors(result.status, result.response);\n        }\n    }\n}\n\n\n//# sourceURL=webpack://main/./src/actions/boards/option/lists/option/cards/option/rename.ts?");
